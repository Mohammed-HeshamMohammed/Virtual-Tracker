...
| Landing-Web | `NEXT_PUBLIC_DASHBOARD_URL`, `NEXT_PUBLIC_LANDING_API_URL`, `NEXT_PUBLIC_AUTH_API_URL`, `NEXT_PUBLIC_DASHBOARD_API_URL` | `APP_PUBLIC_URL`, `NEXT_PUBLIC_LANDING_API_URL`, `NEXT_PUBLIC_AUTH_API_URL`, `NEXT_PUBLIC_DASHBOARD_API_URL` |
