 ...
 *  card for space. In their place: what a task's progress bar would have
 *  answered ("what am I actually doing here") for a project that has no
 *  task to show one for - this week's top apps, and recent screenshots. */
