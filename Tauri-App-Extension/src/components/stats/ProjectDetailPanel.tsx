...
type ProjectDetailPanelProps = {
  ...
  /** False leaves the screenshots out and gives the top apps the whole
   *  card - the Focus layout, where the pane has no room for both. */
...
export function ProjectDetailPanel({
  ...
  const showShots = showScreenshots && (screenshots.length > 0 || loading);
