  ...
  return (
    <main className="agent-tray view-home">
      ...
      <div className="reconnect-body">
        <div data-help="The notice your organization requires you to read before tracking. It says what is collected and why." className="notice-card">
          <h1 className="reconnect-name">Before you start tracking</h1>
          <pre className="notice-text">{notice.text}</pre>
          <button data-tip="Confirm you have read this notice and continue"
