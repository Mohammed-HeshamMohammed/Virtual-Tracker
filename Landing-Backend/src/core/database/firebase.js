...
/** @internal Test simulation only â€” in-memory Firestore stand-in. */
export function __setTestDb(override) {
  testDbOverride = override ?? null;
}

/** @internal Test simulation only â€” mock Firebase Auth Admin. */
...
/** Default Storage bucket for the initialized app */
