 ...
 * Never log getEnv directly â€” secrets live in email, firebase.admin, and monitor.
 */

/**
 * @param {import("./index.js").AppEnv} config
 */
export function toPublicEnv(config) {
  ...
  return Object.freeze({
    ...
    server: Object.freeze({ port: config.server.port, host: config.server.host }),
