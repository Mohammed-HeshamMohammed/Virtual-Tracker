        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="absolute left-0 top-full mt-1 z-20 w-full bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-lg py-1 max-h-48 overflow-y-auto"
            >
              {members.map((member) => (
                <button
                  key={member.id}
