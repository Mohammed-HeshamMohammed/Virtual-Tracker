...
const HEADER_TOOLTIP =
  "This setting controls if a notification is sent to owners and managers when a team member missed a work break, took one they didn't earn or took it longer than allotted."

const GLOBAL_TOOLTIP = "Organization default. This is what all current and future members will be set to."

export function WorkBreakNotificationsPanel() {
