  ...
  return (
    <div className="overflow-hidden rounded-xl border border-slate-100 bg-white shadow-sm">
      <div className="border-b border-slate-50 px-6 py-3">
        <h3 className="text-base font-semibold text-slate-800">Average activity by day</h3>
      </div>
      <div className="px-6 pb-4 pt-2">
        ...
        >
          ...
          <text x={4} y={yAt(100) + 4} className="fill-slate-400 text-[10px]">
            100%
          </text>
          <text x={4} y={yAt(75) + 4} className="fill-slate-400 text-[10px]">
            75%
          </text>
          <text x={4} y={yAt(50) + 4} className="fill-slate-400 text-[10px]">
            50%
          </text>
          <text x={4} y={yAt(25) + 4} className="fill-slate-400 text-[10px]">
            25%
          </text>
          <text x={4} y={yAt(0) + 4} className="fill-slate-400 text-[10px]">
            0%
          </text>
          <line
            x1={leftPad}
  ...
  return (
    <div className="relative isolate min-h-0">
      <div className="report-print-area relative mx-auto min-h-[min(80vh,56rem)] max-w-[1400px] space-y-6 px-6 py-6">
              ...
              {(["me", "all"] as const).map((v) => (
                <button
                  ...
                  className={cn(
                    ...
                    scope === v ? "border-blue-500 text-blue-600" : "border-transparent text-slate-400 hover:text-slate-600"
                  )}
                >
                  {v === "me" ? "ME" : "ALL"}
                </button>
            ...
            <div className="flex flex-wrap items-center gap-1.5">
              ...
              <div className="relative z-50">
                <button
                  ...
                  className={cn(
                    "flex min-w-[260px] items-center gap-2 rounded-lg border bg-white px-4 py-2 text-sm text-slate-700 hover:bg-slate-50",
        ...
        <div className="flex flex-wrap items-stretch gap-0 rounded-xl border border-slate-100 bg-white shadow-sm">
          <div className="flex min-w-[100px] flex-1 flex-col justify-center border-r border-slate-100 px-6 py-5">
          ...
          <div className="flex min-w-[100px] flex-1 flex-col justify-center border-r border-slate-100 px-6 py-5">
            <div className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Break time</div>
            <div className="mt-1 text-2xl font-semibold tabular-nums text-slate-800 sm:text-3xl">
          ...
          <div className="flex min-w-[100px] flex-1 flex-col justify-center px-6 py-5">
            <div className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Avg. activity</div>
          ...
          <div className="flex items-center border-l border-slate-100 px-3">
            <button
              ...
              className={cn(
                ...
                showActivityChart ? "bg-blue-500" : "bg-slate-200"
              )}
              aria-expanded={showActivityChart}
              aria-label={showActivityChart ? "Hide activity chart" : "Show activity chart"}
            >
              <LineChart className={cn("h-6 w-6", showActivityChart ? "text-white" : "text-slate-600")} strokeWidth={2} />
            </button>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <div className="text-2xl font-bold text-slate-900">{WORK_SESSIONS_ORG_LABEL}</div>
              <div className="text-sm text-slate-500">{WORK_SESSIONS_TIMEZONE_LABEL}</div>
            </div>
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex flex-wrap items-center gap-1 border-l border-slate-200 pl-3">
                <Button
                  type="button"
                  variant="ghost"
                  size="sm"
                ...
                <Button type="button" variant="ghost" size="sm" className="gap-1 text-slate-600" onClick={() => setSendOpen(true)}>
                  <Send className="h-4 w-4" />
                  Send
                </Button>
                <Button type="button" variant="ghost" size="sm" className="gap-1 text-slate-600" onClick={() => setScheduleOpen(true)}>
                  <Clock className="h-4 w-4" />
                  Schedule
                </Button>
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button type="button" variant="ghost" size="sm" className="gap-1 text-slate-600">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button type="button" variant="ghost" size="icon" className="text-slate-500" aria-label="Table settings">
                  ...
                  <PopoverContent className="w-56 p-3" align="end">
                    ...
                    <div className="space-y-1">
                      {COLUMN_META.map((c) => (
                        ...
                        >
                          {c.label}
                          <span className={cn("text-xs", columnVisibility[c.key] ? "text-blue-600" : "text-slate-300")}>
          ...
          <div className="overflow-hidden rounded-xl border border-slate-100 bg-white shadow-sm">
                    ...
                    <Fragment key={g.key}>
                      <tr className="bg-slate-100">
                        <td colSpan={colCount} className="px-4 py-2">
                          ...
                          >
                            <LayoutList className="h-4 w-4 shrink-0 text-slate-500" />
                            <span>{g.label}</span>
                            <ChevronDown
                              className={cn(
                        ...
                        ? g.rows.map((r) => (
                            <tr key={r.id} className="border-b border-slate-100 bg-white">
                              {columnVisibility.client ? (
                                <td className="px-4 py-3 text-sm text-slate-800">{r.client}</td>
                              ) : null}
                              {columnVisibility.project ? (
                                <td className="px-4 py-3">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm text-slate-800">{r.projectName}</span>
                                  </div>
                                </td>
                              ) : null}
                              {columnVisibility.member ? (
                                <td className="px-4 py-3">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm text-slate-800">{r.memberName}</span>
                                  </div>
                                </td>
                              ) : null}
                              {columnVisibility.todo ? (
                                <td className="px-4 py-3 text-sm text-slate-600">{r.todoJob}</td>
                              ) : null}
                              {columnVisibility.manual ? (
                                <td className="px-4 py-3 text-center text-sm tabular-nums text-slate-700">{r.manualPct}%</td>
                              ) : null}
                              {columnVisibility.started ? (
                                <td className="px-4 py-3 text-sm text-slate-600">{r.startedLabel}</td>
                              ) : null}
                              {columnVisibility.stopped ? (
                                <td className="px-4 py-3 text-sm text-slate-600">{r.stoppedLabel}</td>
                              ) : null}
                              {columnVisibility.duration ? (
                                <td className="px-4 py-3 text-right text-sm tabular-nums text-slate-800">{r.durationHms}</td>
                              ) : null}
                              {columnVisibility.activity ? (
                                <td className="px-4 py-3 text-right text-sm tabular-nums text-slate-800">{r.activityPct}%</td>
                              ) : null}
                            </tr>
                          ))
                        : null}
            ...
            {tableCollapsed ? (
              <div className="px-4 py-8 text-center text-sm text-slate-500">Table collapsed. Use Expand to show sessions.</div>
            ) : null}
          </div>
        </div>
