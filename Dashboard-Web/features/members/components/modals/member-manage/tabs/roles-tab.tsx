    ...
    <div className="space-y-6">
      <div>
        <div className="mb-1.5 flex items-center justify-between gap-2">
          <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500" htmlFor="member-role-select">
            Role <span className="text-red-500">*</span>
          </label>
          <button type="button" className="text-xs font-medium text-blue-600 dark:text-emerald-400 hover:underline">
            Learn more
          </button>
        </div>
        ...
        {roleLocked ? (
          <div className="space-y-2">
            <div className="flex items-center gap-2 rounded-lg border border-amber-200 dark:border-amber-900/60 bg-amber-50 dark:bg-amber-950/60 px-3 py-2.5 text-sm text-amber-900 dark:text-amber-300">
            ...
            <div
              ...
              className="rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/60 px-3 py-2.5 text-sm font-semibold text-slate-800 dark:text-slate-200"
              aria-readonly="true"
            >
              {memberRole}
            </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50 p-4">
          <div className="mb-2 flex items-center gap-1 text-sm font-semibold text-slate-800 dark:text-slate-200">
            Projects
            <Info className="h-3.5 w-3.5 text-slate-400 dark:text-slate-500" />
          </div>
          <p className="mb-2 text-xs text-slate-500 dark:text-slate-400">Able to track time on these projects</p>
        ...
        <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50 p-4">
          ...
          <p className="mb-2 text-xs text-slate-500 dark:text-slate-400">Member in these teams</p>
          <div className="rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2 text-sm text-slate-600 dark:text-slate-300">
