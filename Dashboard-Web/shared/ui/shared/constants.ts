...
export const TOPBAR_THEME_DARK = {
  ...
  chevron:       "text-[#bccbb9]",
  // An inset field with its own border: the header is #151b2d, and the old
  // #191f31 fill with no border was all but invisible against it.
  searchWrap:    "bg-[#0c1120] border-[#2e3447] shadow-inner shadow-black/20 hover:border-[#414b68] focus-within:border-[#4be277]/60 focus-within:ring-2 focus-within:ring-[#4be277]/20",
  searchBg:      "bg-[#1a2235] border-white/10 text-white placeholder:text-white/20",
  searchIcon:    "text-[#8f98b8]",
  searchInput:   "text-[#dce1fb] placeholder:text-[#8f98b8]",
...
export const TOPBAR_THEME_LIGHT = {
  ...
  searchWrap:    "bg-white border-slate-300 shadow-sm hover:border-slate-400 focus-within:border-[#6b38d4]/60 focus-within:ring-2 focus-within:ring-[#6b38d4]/20",
  searchBg:      "bg-white border-slate-200 text-slate-700 placeholder:text-slate-300",
  searchIcon:    "text-slate-500",
  searchInput:   "text-slate-800 placeholder:text-slate-500",
