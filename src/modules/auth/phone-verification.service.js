...
/** @returns {boolean} True when OTP is logged to the server console (local testing). */
 ...
 * @param {string} phone
 * @param {{ uid?: string, memberId?: string }} [context]
 */
...
/**
 * After Firebase client phone auth, exchange a fresh ID token for a backend verification token.
 *
 * @param {import("firebase-admin/firestore").Firestore} db
 * @param {import("firebase-admin/auth").Auth} authAdmin
 * @param {{ idToken: string, phone: string, uid?: string, memberId?: string }} input
 */
 ...
 * @param {string} token
 * @param {string} phone
 * @param {{ consume?: boolean, uid?: string }} [options]
 */
